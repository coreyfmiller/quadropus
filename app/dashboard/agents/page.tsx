  ...
  return (
    <div className="p-6 lg:p-8">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-semibold tracking-tight text-foreground">AI Agents</h1>
          <p className="text-[13px] font-light text-muted-foreground">Manage your deployed chat agents.</p>
        </div>
      </div>
