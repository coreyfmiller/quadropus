    ...
    <div className="p-6 lg:p-8">
      <div className="flex items-center gap-3">
        <div className="flex size-10 items-center justify-center rounded-xl border border-border bg-secondary/60 text-brand">
          <LineChart className="size-[18px]" strokeWidth={1.5} />
        </div>
        <div>
          <h1 className="text-xl font-semibold tracking-tight text-foreground">Grow</h1>
          <p className="text-[13px] font-light text-muted-foreground">SEO, AI visibility, and content performance.</p>
        </div>
      </div>
