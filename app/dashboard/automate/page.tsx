  ...
  return (
    <div className="p-6 lg:p-8">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-semibold tracking-tight text-foreground">Automate</h1>
          <p className="text-[13px] font-light text-muted-foreground">AI agents, workflows, and lead follow-up.</p>
        </div>
      </div>
