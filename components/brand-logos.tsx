// Brand marks sourced from theSVG.org. Trademarks belong to their owners.
...
export function AnthropicLogo({ className }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      className={className}
...
export function XaiLogo({ className }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      className={className}
